...
| **AI governance**        | IBM **watsonx.governance** + `scripts/evaluate_briefs.py`  | Headline-number drift check: every brief in `briefs.json` verified against its structured fields. Model card at `governance/model_card.md`.       |
